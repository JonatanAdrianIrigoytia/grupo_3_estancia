...
window.addEventListener("load", function () {
	...
	let confirmPasswordErrorArray = [true, true, true, true, true, true];
	...
	function checkPassword2() {
		...
		if (
			...
			passwordMatchError.classList.remove("invalid");
			passwordMatchError.classList.add("valid");
			confirmPasswordErrorArray[5] = false;
		} else {
			passwordMatchError.classList.remove("valid");
			passwordMatchError.classList.add("invalid");
			confirmPasswordErrorArray[5] = true;
		}
